...
static const unsigned int smartgaps = 1;        /* hide gaps when there is only one client */
...
static const char *fonts[]          = {
	"FiraCode:size=14:antialias=true:autohint=true",
	"IPAGothic:size=14:antialias=true:autohint=true",
	"Symbols Nerd Font:size=14:antialias=true:autohint=true",
};
static const char dmenufont[]       = "FiraCode:style=medium:size=14:antialias=true:autohint=true";
...
static const char *dmenucmd[] = { "rofi", "-show", "drun", "-show-icons", "-m", dmenumon, NULL };
static const char *wallpaper[] = { "random_wallpaper.sh", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,               XK_bracketleft,             spawn,          {.v = wallpaper } },
	{ MODKEY,				XK_p,						spawn,          {.v = powermenu } },
	{ MODKEY,				XK_s,						spawn,          SHCMD("kill -s 10 $(pgrep slstatus)") },
